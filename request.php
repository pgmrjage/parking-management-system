...
$query = "SELECT * FROM vehicles WHERE status = 'pending' AND typeofapplicant = 'request' ORDER BY date LIMIT 15";
                  ...
                  <tbody> <!-- Add tbody tag here -->
                    ...
                    ?>
                      ...
                      <tr>
                        ...
                        <td><?php echo $userdata['Phone number']; ?></td>
                        ...
                        <td>
                            <form method="post" action="">
                                ...
                                <button type="submit" name="acceptButton" onclick="return confirm('Are you sure you want to ACCEPT this request?')" >Accept</button>  
                                <button type="submit" name="rejectButton" onclick="return confirm('Are you sure you want to REJECT this request?')">Reject</button>
                            </form> 
                                    ...
                                    while ($rowImage = $resultImages->fetch_assoc()) {
                                      ...
                                      if (file_exists($imagePath)) {
                                        if (unlink($imagePath)) {
                                          ...
                                          // echo "<script>alert('File $imageName deleted successfully.');</script>"; 
                                        } else {
                                          // echo "Error deleting file $imageName.";
                                          // echo "<script>alert('Error deleting file $imageName.');</script>"; 
                                          // Handle errors here
                                        }
                                      } else {
                                        // echo "<script>alert('File $imageName does not exist.');</script>"; 
